...
from .cmodule import py_lr_fit, py_lr_predict
...
class LogisticRegressionClassifier(BaseClassifier):
    ...
    def fit(self, X:np.ndarray, y:np.ndarray) -> 'LogisticRegressionClassifier':
        ...
        self.coef_, self.intercept_ = py_lr_fit(X,y, self.n_iterations, self.learning_rate)
        self.fitted = True
        return self
    ...
    def predict(self, X:np.ndarray) -> np.ndarray:
        ...
        return py_lr_predict(self.coef_, self.intercept_, X)
